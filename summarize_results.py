...
med_tasks = ['MedExamRetrieval', "DuBaikeRetrieval", "DXYDiseaseRetrieval",
                  'MedicalRetrieval', "CmedqaRetrieval", "DXYConsultRetrieval",
                  "CovidRetrieval", "IIYIPostRetrieval", "CSLCiteRetrieval", "CSLRelatedRetrieval"]

med_models = ['bge-large-zh-v1.5']
    ...
    for t_type in task_types:
        ...
        for t in MTEB(task_types=[t_type], task_langs=args.lang).tasks:
            ...
            for model_name in os.listdir(args.results_dir):
                if model_name not in med_models:
                    continue
    ...
    with open(save_file, 'w') as f:
        for t_type, type_results in tasks_results.items():
            ...
            for model in model_names:
                ...
                cqa_res = []
                for task_name in med_tasks:
                    if task_name not in type_results:
                        continue
